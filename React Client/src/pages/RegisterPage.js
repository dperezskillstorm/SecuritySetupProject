...
const RegisterPage=()=>{
    ...
    const handleSubmit=(event)=>{
        ...
        //if we can set token right away we can have it redirect starign to dashboard
                        ...
                        <div className="card-body">
                            ...
                            <form className="my-login-validation" onSubmit={handleSubmit} noValidate={false}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input id="firstName" type="text" className="form-control" minLength={3} value={values.firstName} onChange={handleChange} name="firstName" required/>
                                    <div className="invalid-feedback">
                                ...
                                <div className="form-group">
                                    ...
                                    <input id="lastName" type="text" className="form-control" minLength={3} value={values.lastName} onChange={handleChange} name="lastName" required/>
                                    <div className="invalid-feedback">
                                        Name length too short
                                    </div>
                                </div>
                                ...
                                <div className="form-group">
                                    <div className="custom-control custom-checkbox">
                                        ...
                                        <label className="custom-control-label" htmlFor="customCheck1">Remember me <a onClick={()=>navigate("/")} className="float-right">Need to Login?</a></label>
                                     </div>
                                </div>
